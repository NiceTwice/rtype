//
// LoaderException.hpp for RTYPE - Server in /home/cugede/work/epitech/rendu/TEK3/CPP/rtype/server/include/exceptions
//
...
{
public:
  LoaderException(std::string const &what) throw() : _what(what) {}
